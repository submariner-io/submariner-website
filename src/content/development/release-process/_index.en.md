...
4) Make sure the [release job](https://github.com/submariner-io/releases/actions/workflows/release.yml) passed, a
   [shipyard release](https://github.com/submariner-io/submariner-operator/releases) was created and the
